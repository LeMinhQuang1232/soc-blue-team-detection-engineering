# ATT&CK and Control Mapping — P4-EXEC-01

The primary mapping used for this test is **T1059.001 — PowerShell**. The mapping is based on the observed action and is kept separate from tool-specific rule metadata where appropriate.
...
- [Relevant screenshot folder](../../../screenshots/02-endpoint-execution/)
