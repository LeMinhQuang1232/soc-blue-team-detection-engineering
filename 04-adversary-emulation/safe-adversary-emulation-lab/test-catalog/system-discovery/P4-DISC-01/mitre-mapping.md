# ATT&CK and Control Mapping — P4-DISC-01

The primary mapping used for this test is **T1082 — System Information Discovery**. The mapping is based on the observed action and is kept separate from tool-specific rule metadata where appropriate.
