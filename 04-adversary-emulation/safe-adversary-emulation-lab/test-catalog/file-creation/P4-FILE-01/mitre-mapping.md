# ATT&CK and Control Mapping — P4-FILE-01

The primary mapping used for this test is **T1105 — Ingress Tool Transfer (harmless laboratory artifact)**. The mapping is based on the observed action and is kept separate from tool-specific rule metadata where appropriate.
...
- [Relevant screenshot folder](../../../screenshots/05-file-transfer/)
